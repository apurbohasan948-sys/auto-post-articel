...
import { IntegrationStatusCard } from './dashboard/IntegrationStatusCard.tsx';
...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 1.5 Integrations & Outbound Channels Status (Blogger, Facebook, Instagram, YouTube, TikTok) */}
      <IntegrationStatusCard onNavigateToIntegrations={onNavigateToIntegrations} />
